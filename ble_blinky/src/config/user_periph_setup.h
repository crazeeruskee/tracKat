 ...
 */
    ...
    #define LC_DO_PIN               GPIO_PIN_7
		
		#define LC_CLK_PORT             GPIO_PORT_0
    #define LC_CLK_PIN              GPIO_PIN_8
    ...
    #define SCL_PIN                 GPIO_PIN_8
		...
		#define ACCEL_INT_PORT           GPIO_PORT_0
...
// Define UART2 Tx Pad
    ...
    #define UART2_TX_PIN            GPIO_PIN_5 //GPIO_PIN_6
