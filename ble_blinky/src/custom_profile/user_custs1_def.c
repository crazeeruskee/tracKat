...
const struct attm_desc_128 custs1_att_db[CUSTS1_IDX_NB] =
{
    ...
    [SVC1_IDX_LC_VAL_VAL]           = {SVC1_LC_VAL_UUID_128, ATT_UUID_128_LEN, PERM(RD, ENABLE), 
																					PERM(RI, ENABLE) | DEF_SVC1_LC_VAL_CHAR_LEN, 0, NULL}, //sizeof(uint32_t) - 1, (uint8_t *)load},

     // Load Cell Value Client Characteristic Configuration Descriptor
   // [SVC1_IDX_LC_VAL_NTF_CFG]       = {(uint8_t*)&att_desc_cfg, ATT_UUID_16_LEN, PERM(RD, ENABLE) | PERM(NTF, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
